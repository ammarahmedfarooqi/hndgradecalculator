...
<div class="custom-topbar">
    <span class="custom-topbar-title">Level 3 Extended Computing Diploma Grade Calculator</span>
</div>
""", unsafe_allow_html=True)
...
<div style="display: flex; flex-direction: column; align-items: center;">
    <div class="section-box">
        Level 3 Extended Computing Diploma Grade Calculator
    </div>
...
units = {
    "Information Technology Systems – SMI": 120,
    "Creating Systems to Manage Information": 120,
    "Using Social Media in Business": 90,
    "Programming": 90,
    "Data Modelling": 90,
    "Website Development": 60,
    "Computer Games Development": 60,
    "IT Project Management": 60,
    "Cyber Security and Incident Management": 90,
    "IT Technical Support and Management": 120,
...
# Grade thresholds (total points needed)
grade_thresholds = {
    "DDD*": 270,
    "DDD": 252,
    "D*DD": 234,
    ...
    "MPP": 124,
    "PPP": 108,
    "U": 0,  # Below 108 points
}

grade_options = ["U", "P", "M", "D"]

total_points = 0
unit_points_list = []  # To store unit points for visualization
unit_grades = {}
...
if df['Points'].sum() == 0:
    ...
    bar = alt.Chart(df, height=alt.Step(48)).mark_bar(
        ...
        color=alt.condition(
            ...
            alt.value('gold'),
            alt.Color('Points:Q',
                      scale=alt.Scale(domain=[0, 9, 12, 24, 32],
